package com.dio.just.poccollectionsjava.stream;
 ...
 *
 * Imutável -> Não altera a coleção origem, sempre cria uma nove coleção
 *
 ...
 * ForEach   -> Executa uma determinada lógica para cada elemento, retornando a própria coleção
...
public class ExemploStreamAPI {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Operaçõa encadeada: ");
